...
| Функциональный | Простота написания и тестирования, предсказуемость | Ухудшение читаемости |
| Смешанный      | Возможность использование каждой модели там, где её будет использовать лучше всего, гибкость | Большая необходимость за тем, чтобы следить за постоянством стиля кода |
